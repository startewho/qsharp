...
namespace QuickJs
{
    public static unsafe partial class NativeMethods
    {
        ...
        public const uint JS_PROP_CONFIGURABLE = 1;
        public const uint JS_PROP_WRITABLE = 2;
        public const uint JS_PROP_ENUMERABLE = 4;
        public const uint JS_PROP_C_W_E = 7;
        public const uint JS_PROP_LENGTH = 8;
        public const uint JS_PROP_TMASK = 48;
        public const uint JS_PROP_NORMAL = 0;
        public const uint JS_PROP_GETSET = 16;
        public const uint JS_PROP_VARREF = 32;
        public const uint JS_PROP_AUTOINIT = 48;
        public const uint JS_PROP_HAS_SHIFT = 8;
        public const uint JS_PROP_HAS_CONFIGURABLE = 256;
        public const uint JS_PROP_HAS_WRITABLE = 512;
        public const uint JS_PROP_HAS_ENUMERABLE = 1024;
        public const uint JS_PROP_HAS_GET = 2048;
        public const uint JS_PROP_HAS_SET = 4096;
        public const uint JS_PROP_HAS_VALUE = 8192;
        public const uint JS_PROP_THROW = 16384;
        public const uint JS_PROP_THROW_STRICT = 32768;
        public const uint JS_PROP_NO_ADD = 65536;
        public const uint JS_PROP_NO_EXOTIC = 131072;
        public const uint JS_DEFAULT_STACK_SIZE = 262144;
        public const uint JS_EVAL_TYPE_GLOBAL = 0;
        public const uint JS_EVAL_TYPE_MODULE = 1;
        public const uint JS_EVAL_TYPE_DIRECT = 2;
        public const uint JS_EVAL_TYPE_INDIRECT = 3;
        public const uint JS_EVAL_TYPE_MASK = 3;
        public const uint JS_EVAL_FLAG_STRICT = 8;
        public const uint JS_EVAL_FLAG_STRIP = 16;
        public const uint JS_EVAL_FLAG_COMPILE_ONLY = 32;
        public const uint JS_EVAL_FLAG_BACKTRACE_BARRIER = 64;
        public const uint JS_ATOM_NULL = 0;
        public const uint JS_PROCEED_WITH_DEFAULT = 12345;
        public const uint JS_CALL_FLAG_CONSTRUCTOR = 1;
        public const uint JS_GPN_STRING_MASK = 1;
        public const uint JS_GPN_SYMBOL_MASK = 2;
        public const uint JS_GPN_PRIVATE_MASK = 4;
        public const uint JS_GPN_ENUM_ONLY = 16;
        public const uint JS_GPN_SET_ENUM = 32;
        public const uint JS_PARSE_JSON_EXT = 1;
        public const uint JS_WRITE_OBJ_BYTECODE = 1;
        public const uint JS_WRITE_OBJ_BSWAP = 2;
        public const uint JS_WRITE_OBJ_SAB = 4;
        public const uint JS_WRITE_OBJ_REFERENCE = 8;
        public const uint JS_READ_OBJ_BYTECODE = 1;
        public const uint JS_READ_OBJ_ROM_DATA = 2;
        public const uint JS_READ_OBJ_SAB = 4;
        public const uint JS_READ_OBJ_REFERENCE = 8;
        public const uint JS_DEF_CFUNC = 0;
        public const uint JS_DEF_CGETSET = 1;
        public const uint JS_DEF_CGETSET_MAGIC = 2;
        public const uint JS_DEF_PROP_STRING = 3;
        public const uint JS_DEF_PROP_INT32 = 4;
        public const uint JS_DEF_PROP_INT64 = 5;
        public const uint JS_DEF_PROP_DOUBLE = 6;
        public const uint JS_DEF_PROP_UNDEFINED = 7;
        public const uint JS_DEF_OBJECT = 8;
        public const uint JS_DEF_ALIAS = 9;
        ...
        public const int JSCFunctionEnum_JS_CFUNC_generic = 0;
        public const int JSCFunctionEnum_JS_CFUNC_generic_magic = 1;
        public const int JSCFunctionEnum_JS_CFUNC_constructor = 2;
        public const int JSCFunctionEnum_JS_CFUNC_constructor_magic = 3;
        public const int JSCFunctionEnum_JS_CFUNC_constructor_or_func = 4;
        public const int JSCFunctionEnum_JS_CFUNC_constructor_or_func_magic = 5;
        public const int JSCFunctionEnum_JS_CFUNC_f_f = 6;
        public const int JSCFunctionEnum_JS_CFUNC_f_f_f = 7;
        public const int JSCFunctionEnum_JS_CFUNC_getter = 8;
        public const int JSCFunctionEnum_JS_CFUNC_setter = 9;
        public const int JSCFunctionEnum_JS_CFUNC_getter_magic = 10;
        public const int JSCFunctionEnum_JS_CFUNC_setter_magic = 11;
        public const int JSCFunctionEnum_JS_CFUNC_iterator_next = 12;
